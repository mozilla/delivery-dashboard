...
var _mozilla$delivery_dashboard$Types$ReleaseStatus = F2(
	function (a, b) {
		return {status: a, message: b};
	});
var _mozilla$delivery_dashboard$Types$LatestChannelVersions = F4(
	function (a, b, c, d) {
		return {esr: a, release: b, beta: c, nightly: d};
	});
var _mozilla$delivery_dashboard$Types$Model = F8(
	function (a, b, c, d, e, f, g, h) {
		return {latest_channel_versions: a, current_release: b, manual_version: c, archive: d, release_notes: e, security_advisories: f, download_links: g, product_details: h};
	});
var _mozilla$delivery_dashboard$Types$Error = function (a) {
	return {ctor: 'Error', _0: a};
};
var _mozilla$delivery_dashboard$Types$Exists = {ctor: 'Exists'};
var _mozilla$delivery_dashboard$Types$Incomplete = {ctor: 'Incomplete'};
var _mozilla$delivery_dashboard$Types$Missing = {ctor: 'Missing'};
var _mozilla$delivery_dashboard$Types$ProductDetails = {ctor: 'ProductDetails'};
var _mozilla$delivery_dashboard$Types$DownloadLinks = {ctor: 'DownloadLinks'};
var _mozilla$delivery_dashboard$Types$SecurityAdvisories = {ctor: 'SecurityAdvisories'};
var _mozilla$delivery_dashboard$Types$ReleaseNotes = {ctor: 'ReleaseNotes'};
var _mozilla$delivery_dashboard$Types$Archive = {ctor: 'Archive'};
var _mozilla$delivery_dashboard$Types$LatestChannelVersionsFetched = function (a) {
	return {ctor: 'LatestChannelVersionsFetched', _0: a};
};
var _mozilla$delivery_dashboard$Types$ReleaseStatusFetched = F2(
	function (a, b) {
		return {ctor: 'ReleaseStatusFetched', _0: a, _1: b};
	});
var _mozilla$delivery_dashboard$Types$DismissVersion = {ctor: 'DismissVersion'};
var _mozilla$delivery_dashboard$Types$ManualVersion = function (a) {
	return {ctor: 'ManualVersion', _0: a};
};
var _mozilla$delivery_dashboard$Types$Select = function (a) {
	return {ctor: 'Select', _0: a};
};

var _mozilla$delivery_dashboard$Decoder$latestChannelVersionsDecoder = A3(
	...
	A3(
		...
		A3(
			...
			A3(
				...
				'esr',
				_elm_lang$core$Json_Decode$string,
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_mozilla$delivery_dashboard$Types$LatestChannelVersions)))));
var _mozilla$delivery_dashboard$Decoder$statusDecoder = A2(
	_elm_lang$core$Json_Decode$andThen,
	function (value) {
		var _p0 = value;
		switch (_p0) {
			case 'missing':
				return _elm_lang$core$Json_Decode$succeed(_mozilla$delivery_dashboard$Types$Missing);
			case 'incomplete':
				return _elm_lang$core$Json_Decode$succeed(_mozilla$delivery_dashboard$Types$Incomplete);
			case 'exists':
				return _elm_lang$core$Json_Decode$succeed(_mozilla$delivery_dashboard$Types$Exists);
			case 'error':
				return _elm_lang$core$Json_Decode$succeed(
					_mozilla$delivery_dashboard$Types$Error('An error occured'));
			default:
				return _elm_lang$core$Json_Decode$fail(
					A2(_elm_lang$core$Basics_ops['++'], 'Unknown status: ', _p0));
		}
	},
	_elm_lang$core$Json_Decode$string);
var _mozilla$delivery_dashboard$Decoder$releaseStatusDecoder = A4(
	...
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'status',
		_mozilla$delivery_dashboard$Decoder$statusDecoder,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_mozilla$delivery_dashboard$Types$ReleaseStatus)));

var _mozilla$delivery_dashboard$Init$getLatestChannelVersions = A2(
	_lukewestby$elm_http_builder$HttpBuilder$send,
	_mozilla$delivery_dashboard$Types$LatestChannelVersionsFetched,
	A2(
		_lukewestby$elm_http_builder$HttpBuilder$withExpect,
		_elm_lang$http$Http$expectJson(_mozilla$delivery_dashboard$Decoder$latestChannelVersionsDecoder),
		A2(
			_lukewestby$elm_http_builder$HttpBuilder$withTimeout,
			10 * _elm_lang$core$Time$second,
			_lukewestby$elm_http_builder$HttpBuilder$get('https://pollbot.dev.mozaws.net/v1/firefox/ongoing-versions'))));
var _mozilla$delivery_dashboard$Init$init = A2(
	_elm_lang$core$Platform_Cmd_ops['!'],
	{latest_channel_versions: _elm_lang$core$Maybe$Nothing, current_release: _elm_lang$core$Maybe$Nothing, archive: _elm_lang$core$Maybe$Nothing, release_notes: _elm_lang$core$Maybe$Nothing, security_advisories: _elm_lang$core$Maybe$Nothing, download_links: _elm_lang$core$Maybe$Nothing, product_details: _elm_lang$core$Maybe$Nothing, manual_version: ''},
	{
		ctor: '::',
		_0: _mozilla$delivery_dashboard$Init$getLatestChannelVersions,
		_1: {ctor: '[]'}
	});

var _mozilla$delivery_dashboard$Update$getChecksSuffix = function (check) {
	var _p0 = check;
	switch (_p0.ctor) {
		case 'Archive':
			return 'archive';
		case 'ReleaseNotes':
			return 'bedrock/release-notes';
		case 'SecurityAdvisories':
			return 'bedrock/security-advisories';
		case 'DownloadLinks':
			return 'bedrock/download-links';
		default:
			return 'product-details';
	}
};
var _mozilla$delivery_dashboard$Update$getReleaseStatus = F2(
	function (checks, version) {
		var suffix = _mozilla$delivery_dashboard$Update$getChecksSuffix(checks);
		var url = A2(
			_elm_lang$core$Basics_ops['++'],
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				version,
				A2(_elm_lang$core$Basics_ops['++'], '/', suffix)));
		return A2(
			_lukewestby$elm_http_builder$HttpBuilder$send,
			_mozilla$delivery_dashboard$Types$ReleaseStatusFetched(checks),
			A2(
				_lukewestby$elm_http_builder$HttpBuilder$withExpect,
				_elm_lang$http$Http$expectJson(_mozilla$delivery_dashboard$Decoder$releaseStatusDecoder),
				A2(
					_lukewestby$elm_http_builder$HttpBuilder$withTimeout,
					10 * _elm_lang$core$Time$second,
					_lukewestby$elm_http_builder$HttpBuilder$get(url))));
	});
var _mozilla$delivery_dashboard$Update$refreshStatus = function (version) {
	return {
		ctor: '::',
		_0: A2(_mozilla$delivery_dashboard$Update$getReleaseStatus, _mozilla$delivery_dashboard$Types$Archive, version),
		_1: {
			ctor: '::',
			_0: A2(_mozilla$delivery_dashboard$Update$getReleaseStatus, _mozilla$delivery_dashboard$Types$ReleaseNotes, version),
			_1: {
				ctor: '::',
				_0: A2(_mozilla$delivery_dashboard$Update$getReleaseStatus, _mozilla$delivery_dashboard$Types$SecurityAdvisories, version),
				_1: {
					ctor: '::',
					_0: A2(_mozilla$delivery_dashboard$Update$getReleaseStatus, _mozilla$delivery_dashboard$Types$DownloadLinks, version),
					_1: {
						ctor: '::',
						_0: A2(_mozilla$delivery_dashboard$Update$getReleaseStatus, _mozilla$delivery_dashboard$Types$ProductDetails, version),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _mozilla$delivery_dashboard$Update$update = F2(
	function (msg, model) {
		update:
		while (true) {
			var _p1 = msg;
			switch (_p1.ctor) {
				case 'Select':
					var _p2 = _p1._0;
					if (_elm_lang$core$Native_Utils.eq(_p2, '')) {
						var _v2 = _mozilla$delivery_dashboard$Types$DismissVersion,
							_v3 = model;
						msg = _v2;
						model = _v3;
						continue update;
						...
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{
									current_release: _elm_lang$core$Maybe$Just(_p2),
									manual_version: _p2,
									archive: _elm_lang$core$Maybe$Nothing,
									release_notes: _elm_lang$core$Maybe$Nothing,
									security_advisories: _elm_lang$core$Maybe$Nothing,
									download_links: _elm_lang$core$Maybe$Nothing,
									product_details: _elm_lang$core$Maybe$Nothing
								}),
							_mozilla$delivery_dashboard$Update$refreshStatus(_p2));
					}
				case 'ManualVersion':
					var _p3 = _p1._0;
					if (_elm_lang$core$Native_Utils.eq(_p3, '')) {
						var _v4 = _mozilla$delivery_dashboard$Types$DismissVersion,
							_v5 = model;
						msg = _v4;
						model = _v5;
						continue update;
				...
				case 'DismissVersion':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{manual_version: '', current_release: _elm_lang$core$Maybe$Nothing, archive: _elm_lang$core$Maybe$Nothing, release_notes: _elm_lang$core$Maybe$Nothing, security_advisories: _elm_lang$core$Maybe$Nothing, download_links: _elm_lang$core$Maybe$Nothing, product_details: _elm_lang$core$Maybe$Nothing}),
						{ctor: '[]'});
				case 'ReleaseStatusFetched':
					if (_p1._1.ctor === 'Ok') {
						var _p5 = _p1._1._0;
						var _p4 = _p1._0;
						switch (_p4.ctor) {
							case 'Archive':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											archive: _elm_lang$core$Maybe$Just(_p5)
										}),
									{ctor: '[]'});
							case 'ReleaseNotes':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											release_notes: _elm_lang$core$Maybe$Just(_p5)
										}),
									{ctor: '[]'});
							case 'SecurityAdvisories':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											security_advisories: _elm_lang$core$Maybe$Just(_p5)
										}),
									{ctor: '[]'});
							case 'DownloadLinks':
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											download_links: _elm_lang$core$Maybe$Just(_p5)
										}),
									{ctor: '[]'});
							default:
								return A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{
											product_details: _elm_lang$core$Maybe$Just(_p5)
										}),
									{ctor: '[]'});
						}
					} else {
						var _p6 = A2(_elm_lang$core$Debug$log, 'Error', _p1._1._0);
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							model,
							{ctor: '[]'});
					...
					if (_p1._0.ctor === 'Ok') {
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{
									latest_channel_versions: _elm_lang$core$Maybe$Just(_p1._0._0)
								}),
							{ctor: '[]'});
					} else {
						var _p7 = A2(_elm_lang$core$Debug$log, 'Error', _p1._0._0);
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							model,
							{ctor: '[]'});
...
var _mozilla$delivery_dashboard$View$releaseStatus = function (model) {
	var extractStatus = function (release_status) {
		var _p0 = release_status;
		if (_p0.ctor === 'Nothing') {
			return _elm_lang$core$Maybe$Nothing;
		} else {
			return _elm_lang$core$Maybe$Just(_p0._0.status);
		}
	};
	var tasks = {
		ctor: '_Tuple5',
		_0: extractStatus(model.archive),
		_1: extractStatus(model.release_notes),
		_2: extractStatus(model.security_advisories),
		_3: extractStatus(model.download_links),
		_4: extractStatus(model.product_details)
	};
	var _p1 = tasks;
	_v1_2:
	do {
		if (_p1.ctor === '_Tuple5') {
			if (_p1._0.ctor === 'Nothing') {
				if ((((_p1._1.ctor === 'Nothing') && (_p1._2.ctor === 'Nothing')) && (_p1._3.ctor === 'Nothing')) && (_p1._4.ctor === 'Nothing')) {
					return _elm_lang$core$Maybe$Nothing;
				} else {
					break _v1_2;
				}
			} else {
				if (((((((((_p1._0._0.ctor === 'Exists') && (_p1._1.ctor === 'Just')) && (_p1._1._0.ctor === 'Exists')) && (_p1._2.ctor === 'Just')) && (_p1._2._0.ctor === 'Exists')) && (_p1._3.ctor === 'Just')) && (_p1._3._0.ctor === 'Exists')) && (_p1._4.ctor === 'Just')) && (_p1._4._0.ctor === 'Exists')) {
					return _elm_lang$core$Maybe$Just(
						{
							status: _mozilla$delivery_dashboard$Types$Exists,
							message: _elm_lang$core$Maybe$Just('All checks validates, the release is complete.')
						});
				} else {
					break _v1_2;
				}
	...
	return _elm_lang$core$Maybe$Just(
		{
			status: _mozilla$delivery_dashboard$Types$Incomplete,
			message: _elm_lang$core$Maybe$Just('One of the release checks did not validate')
		});
};
var _mozilla$delivery_dashboard$View$clearableTextInput = F3(
	function (onClearMsg, attrs, txt) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('btn-group clearable-text'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				...
				_1: {
					...
					_0: (_elm_lang$core$Native_Utils.cmp(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('text-clear-btn'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(onClearMsg),
								_1: {ctor: '[]'}
							}
						},
						{
...
var _mozilla$delivery_dashboard$View$searchForm = function (txt) {
	return A2(
		_elm_lang$html$Html$form,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('search-form well'),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onSubmit(
					_mozilla$delivery_dashboard$Types$Select(txt)),
				_1: {ctor: '[]'}
			}
		},
		{
			ctor: '::',
			_0: A3(
				_mozilla$delivery_dashboard$View$clearableTextInput,
				_mozilla$delivery_dashboard$Types$DismissVersion,
				{
					ctor: '::',
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$placeholder('Firefox version, eg. \"57.0\"'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$value(txt),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onInput(_mozilla$delivery_dashboard$Types$ManualVersion),
									_1: {ctor: '[]'}
								}
							}
						}
...
var _mozilla$delivery_dashboard$View$spinner = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
	...
	{ctor: '[]'});
var _mozilla$delivery_dashboard$View$displayStatus = F2(
	function (link, release_status) {
		var _p2 = release_status;
		if (_p2.ctor === 'Nothing') {
			return _mozilla$delivery_dashboard$View$spinner;
		} else {
			var _p4 = _p2._0;
			var _p3 = _p4.status;
			switch (_p3.ctor) {
				case 'Exists':
					return A2(
						_elm_lang$html$Html$a,
						{
							...
							_1: {
								...
								_0: _elm_lang$html$Html_Attributes$title(
									A2(_elm_lang$core$Maybe$withDefault, '', _p4.message)),
								_1: {
									ctor: '::',
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Exists'),
							_1: {ctor: '[]'}
						});
				case 'Incomplete':
					return A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('label label-info'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$title(
									A2(_elm_lang$core$Maybe$withDefault, '', _p4.message)),
				...
				case 'Missing':
					return A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('label label-danger'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$title(
									A2(_elm_lang$core$Maybe$withDefault, '', _p4.message)),
				...
				default:
					return A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('label label-warning'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$title(
									A2(_elm_lang$core$Maybe$withDefault, '', _p4.message)),
...
var _mozilla$delivery_dashboard$View$dashboardView = F2(
		...
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('table table-stripped table-hover'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
										...
										_0: A2(
											...
											{ctor: '[]'},
											{
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text('Release'),
														_1: {ctor: '[]'}
													}),
												_1: {
													ctor: '::',
													_0: A2(
														_mozilla$delivery_dashboard$View$displayStatus,
														'#',
														_mozilla$delivery_dashboard$View$releaseStatus(model)),
													_1: {ctor: '[]'}
												}
											}),
										_1: {
												...
												_0: A2(
													...
													{ctor: '[]'},
													{
														...
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html$text('Product details'),
																_1: {ctor: '[]'}
															}),
														_1: {
															ctor: '::',
															_0: A2(_mozilla$delivery_dashboard$View$displayStatus, 'https://product-details.mozilla.org/1.0/firefox.json', model.product_details),
															_1: {ctor: '[]'}
														}
													}),
												_1: {ctor: '[]'}
											...
											_0: A2(
												...
												{ctor: '[]'},
												{
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text('Release Notes'),
															_1: {ctor: '[]'}
														}),
													_1: {
														ctor: '::',
														_0: A2(
															...
															A2(
																...
																A2(_elm_lang$core$Basics_ops['++'], version, '/releasenotes/')),
															model.release_notes),
														_1: {ctor: '[]'}
													}
												}),
												...
												_0: A2(
													...
													{ctor: '[]'},
													{
														...
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html$text('Security Advisories'),
																_1: {ctor: '[]'}
															}),
														_1: {
															ctor: '::',
															_0: A2(_mozilla$delivery_dashboard$View$displayStatus, 'https://www.mozilla.org/en-US/security/known-vulnerabilities/firefox/', model.security_advisories),
															_1: {ctor: '[]'}
														}
													}),
												_1: {
													...
													_0: A2(
														...
														{ctor: '[]'},
														{
															...
															_0: A2(
																...
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html$text('Download links'),
																	_1: {ctor: '[]'}
																}),
															_1: {
																ctor: '::',
																_0: A2(_mozilla$delivery_dashboard$View$displayStatus, 'https://www.mozilla.org/en-US/firefox/all/', model.download_links),
																_1: {ctor: '[]'}
															}
														}),
													_1: {ctor: '[]'}
...
var _mozilla$delivery_dashboard$View$releasesMenu = function (latest_channel_versions) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Firefox Releases'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}),
			_1: {
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						ctor: '::',
						_0: function () {
							var _p5 = latest_channel_versions;
							if (_p5.ctor === 'Nothing') {
								return _mozilla$delivery_dashboard$View$spinner;
							} else {
								var _p6 = _p5._0;
												...
												_0: A2(
													_elm_lang$html$Html$a,
													{
														...
														_0: _elm_lang$html$Html_Events$onClick(
															_mozilla$delivery_dashboard$Types$Select(version)),
														_1: {ctor: '[]'}
													},
													{
														ctor: '::',
								...
								return A2(
									...
									{
										ctor: '::',
										_0: A2(releaseItem, 'Nightly', _p6.nightly),
										_1: {
											ctor: '::',
											_0: A2(releaseItem, 'Beta', _p6.beta),
											_1: {
												ctor: '::',
												_0: A2(releaseItem, 'Release', _p6.release),
												_1: {
													ctor: '::',
													_0: A2(releaseItem, 'ESR', _p6.esr),
													_1: {ctor: '[]'}
												}
											}
										}
...
var _mozilla$delivery_dashboard$View$headerView = function (model) {
	return A2(
					...
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Delivery Dashboard'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}),
...
var _mozilla$delivery_dashboard$View$mainView = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _mozilla$delivery_dashboard$View$searchForm(model.manual_version),
					_1: {
						ctor: '::',
						_0: function () {
							var _p7 = model.current_release;
							if (_p7.ctor === 'Nothing') {
								return A2(
									_elm_lang$html$Html$div,
									{ctor: '[]'},
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Learn more about a specific version. '),
										_1: {
											ctor: '::',
											_0: A2(
												_elm_lang$html$Html$strong,
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Select or enter your version number.'),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}
								...
								return A2(_mozilla$delivery_dashboard$View$dashboardView, _p7._0, model);
							}
						}(),
						_1: {ctor: '[]'}
					}
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _mozilla$delivery_dashboard$View$releasesMenu(model.latest_channel_versions),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _mozilla$delivery_dashboard$View$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		{
			ctor: '::',
			_0: _mozilla$delivery_dashboard$View$headerView(model),
			_1: {
				ctor: '::',
				_0: _mozilla$delivery_dashboard$View$mainView(model),
				_1: {ctor: '[]'}
			}
		});
};

var _mozilla$delivery_dashboard$Main$main = _elm_lang$html$Html$program(
	{
		init: _mozilla$delivery_dashboard$Init$init,
		view: _mozilla$delivery_dashboard$View$view,
		update: _mozilla$delivery_dashboard$Update$update,
		subscriptions: _elm_lang$core$Basics$always(_elm_lang$core$Platform_Sub$none)
	})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _mozilla$delivery_dashboard$Main$main !== 'undefined') {
    _mozilla$delivery_dashboard$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Types.Checks":{"args":[],"tags":{"DownloadLinks":[],"ReleaseNotes":[],"Archive":[],"SecurityAdvisories":[],"ProductDetails":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Types.Status":{"args":[],"tags":{"Exists":[],"Error":["String"],"Missing":[],"Incomplete":[]}},"Types.Msg":{"args":[],"tags":{"LatestChannelVersionsFetched":["Result.Result Http.Error Types.LatestChannelVersions"],"ReleaseStatusFetched":["Types.Checks","Result.Result Http.Error Types.ReleaseStatus"],"DismissVersion":[],"Select":["Types.Version"],"ManualVersion":["String"]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}},"aliases":{"Types.Version":{"args":[],"type":"String"},"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"Types.LatestChannelVersions":{"args":[],"type":"{ esr : String, release : String, beta : String, nightly : String }"},"Types.ReleaseStatus":{"args":[],"type":"{ status : Types.Status, message : Maybe.Maybe String }"}},"message":"Types.Msg"},"versions":{"elm":"0.18.0"}});
}
